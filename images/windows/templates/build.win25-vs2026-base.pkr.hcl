// Windows Server 2025 + VS 2026 Base Image Build Configuration
// 
// Normal build: packer build -only="win25-vs2026-base.proxmox-iso.win25-vs2026-base" .
// Debug build:  packer build -only="win25-vs2026-base.null.winrm" -var="winrm_host=IP" .

build {
  name = "win25-vs2026-base"
