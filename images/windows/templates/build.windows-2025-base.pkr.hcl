...
//
// Normal build: packer build -only="windows-2025-base.proxmox-iso.base" -var="image_os=win25" .
// Debug build:  packer build -only="windows-2025-base.null.winrm" -var="image_os=win25" -var="winrm_host=IP" .
