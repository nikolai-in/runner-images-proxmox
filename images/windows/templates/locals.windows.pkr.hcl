locals {
  ...
  image_properties_map = {
    "win22" = {
      ...
      base_template   = "windows-2022-base"
    ...
    "win22-slim" = {
      ...
      disk_size       = coalesce(var.disk_size_gb, "32G")
      base_template   = "windows-2022-base"
      runner_template = "win22-slim-runner"
      base_vm_id      = var.vm_ids.win22_base == 0 ? null : var.vm_ids.win22_base
      runner_vm_id    = var.vm_ids.win22_slim_runner == 0 ? null : var.vm_ids.win22_slim_runner
      # Reuses the win22 license key; win22-slim runs the same Windows Server 2022 OS
      license_key     = var.license_keys.win22
      driver_paths = [
    ...
    "win25" = {
      ...
      image_index     = "4"
      disk_size       = coalesce(var.disk_size_gb, "32G")
      base_template   = "windows-2025-base"
