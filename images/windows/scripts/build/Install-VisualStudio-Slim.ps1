################################################################################
##  File:  Install-VisualStudio-Slim.ps1
##  Desc:  Install Visual Studio with only the workloads listed in the slim
##         toolset (no --allWorkloads flag so unneeded workloads are skipped).
################################################################################
